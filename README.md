...
Relación OneToMany / ManyToOne --> (animal:adopción) donde un animal pertenece a 1 sola adopción, pero una adopción puede tener muchos animales.

Relación ManyToMany --> (voluntario:animal) donde un voluntario puede hacerse cargo de muchos animales y un animal puede ser atendido por muchos voluntarios
Creamos la relación
![img.png](img.png)
